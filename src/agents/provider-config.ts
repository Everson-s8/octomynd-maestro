...
export const PROVIDER_PRESETS: ProviderPreset[] = [
  {
    ...
    description: "Claude Code using the subscription or credentials already connected to the CLI.",
    models: [],
  ...
  },
  {
    ...
    command: "codex",
    args: ["exec", "{prompt}"],
    description: "OpenAI Codex CLI using the connected account.",
    models: [],
    connectionHint: "account",
    category: "account",
    ...
    authFlows: [
      {
        ...
        description: "Opens the browser to complete sign-in (recommended on desktop).",
        recommended: true,
        kind: "terminal",
        args: ["login"]
      },
      {
        ...
        description: "For environments without a default browser; a code is shown here.",
        kind: "device_code",
        args: ["login", "--device-auth"]
      },
      {
        id: "verify_only",
        label: "I already signed in via terminal",
        description: "Only verifies account status with `codex login status`.",
        kind: "verify_only",
        args: []
      }
    ],
  ...
  },
  {
    ...
    description: "A broad model catalog through one OpenAI-compatible API.",
    models: [],
    connectionHint: "api_key",
    category: "api",
  ...
  },
  {
    ...
    command: "opencode",
    args: ["run", "{prompt}", "-m", "{model}"],
    description: "Models available through the account connected to OpenCode.",
  ...
  },
  {
    ...
    description: "DeepSeek using your own API key.",
    models: [],
    connectionHint: "api_key",
    category: "api",
  ...
  },
  {
    ...
    command: "agy",
    description: "Gemini through the agy CLI, using the Google account authenticated in the local Antigravity session.",
    models: [],
    connectionHint: "account",
    category: "account",
  ...
  },
  {
    ...
    description: "Gemini models through the Google AI API using an API key (without the agy CLI).",
    models: [],
    connectionHint: "api_key",
    category: "api",
  ...
  },
  {
    ...
    command: "copilot",
    args: ["-p", "{prompt}"],
    description: "GitHub Copilot using the account authenticated in GitHub CLI. Requires the '@github/copilot' CLI (npm i -g @github/copilot).",
    connectionHint: "account",
    category: "account",
    docsUrl: "https://docs.github.com/en/copilot/how-tos/set-up/install-copilot-cli",
    setupCommand: "npm i -g @github/copilot",
    authFlow: "terminal",
    authArgs: ["auth", "login"],
    authStatusArgs: ["auth", "status"],
    modelDiscovery: "manual"
