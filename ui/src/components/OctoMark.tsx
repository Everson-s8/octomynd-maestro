    ...
    <svg className={large ? "octo-mark is-large" : "octo-mark"} viewBox="0 0 96 96" role="img" aria-label="Octomynd">
      <defs>
        <linearGradient id="octoBody" x1="20" y1="8" x2="78" y2="86">
          <stop stopColor="#ff47d3" />
          <stop offset="1" stopColor="#d60eb2" />
        </linearGradient>
      </defs>
      <path
        fill="url(#octoBody)"
      ...
      <circle cx="58" cy="35" r="15" fill="#fff" />
      <circle cx="63" cy="35" r="9" fill="#25e6ff" />
      <circle cx="66" cy="34" r="5" fill="#101018" />
      <circle cx="63" cy="31" r="2" fill="#fff" />
