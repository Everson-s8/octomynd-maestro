export function OctoMark({ large = false, color = "#c4622d", secondary = "#9c4d24" }: { large?: boolean; color?: string; secondary?: string }) {
  if (!large) {
    return (
      <svg className="octo-mark octo-mark-brand" viewBox="0 0 200 200" role="img" aria-label="Octomynd">
        <ellipse cx="100" cy="82" rx="54" ry="48" fill={color} />
        <g className="octo-tentacles">
          <path className="octo-tentacle octo-tentacle-left" d="M56 116 C40 138,32 158,38 178" stroke={color} strokeWidth="11" strokeLinecap="round" />
          <path className="octo-tentacle octo-tentacle-right" d="M144 116 C160 138,168 158,162 178" stroke={color} strokeWidth="11" strokeLinecap="round" />
          <path className="octo-tentacle octo-tentacle-inner-left" d="M80 126 C75 148,75 164,80 180" stroke={secondary} strokeWidth="11" strokeLinecap="round" />
          <path className="octo-tentacle octo-tentacle-inner-right" d="M120 126 C125 148,125 164,120 180" stroke={secondary} strokeWidth="11" strokeLinecap="round" />
          <path className="octo-tentacle octo-tentacle-center" d="M100 128 L100 182" stroke={secondary} strokeWidth="11" strokeLinecap="round" />
        </g>
        ...
        <path className="octo-eye-lid" d="M103 76 C106 60,134 58,137 76 C131 66,109 66,103 76Z" fill={color} />
      </svg>
    );
  }
