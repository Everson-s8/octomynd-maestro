...
function Overview({ data, onCreate, onRefresh, onRegisterProject, refreshing }: { data: DashboardData; onCreate: () => void; onRefresh: () => void; onRegisterProject?: () => void; refreshing: boolean }) {
  ...
  return <div className="view active">
    ...
    <FirstRunOnboarding data={data} onCreate={onCreate} onRegisterProject={onRegisterProject} />
...
export function MaestroV2({ data, onRefresh, onCreate, onRegisterProject, onRestartOnboarding, refreshing }: { data: DashboardData; onRefresh: () => void | Promise<void>; onCreate: () => void; onRegisterProject?: () => void; onRestartOnboarding?: () => void; refreshing: boolean }) {
      ...
      <main>
        <div className="inner">
          {taskLogsMatch ? (
            ...
            <SettingsPage data={data} onRefresh={async () => { await onRefresh(); }} onRestartOnboarding={onRestartOnboarding} />
          ) : (
            <Overview data={data} onCreate={onCreate} onRefresh={onRefresh} onRegisterProject={onRegisterProject} refreshing={refreshing} />
          )}
        </div>
      </main>
    </div>
